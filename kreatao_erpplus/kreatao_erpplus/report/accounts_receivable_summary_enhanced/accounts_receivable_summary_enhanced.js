frappe.query_reports["Accounts Receivable Summary Enhanced"] = {
	...
	filters: [
		...
		},
		{
			...
			options: get_ar_enhanced_party_type_options(),
			on_change: function () {
...
erpnext.utils.add_dimensions("Accounts Receivable Summary Enhanced", 9);

function get_ar_enhanced_party_type_options() {
	let options = [];
	frappe.db
